...
class Sports_Fragment : Fragment() {
    ...
    fun searchCrawlingThread(page: Int, value: String = "") {
        //스레드 생성
        thread {
            val URL = "https://hms.swu.ac.kr/bbs/bbs/index.php?bbs_no=7&page_no=${page}&search_kind=subject&search_text=${value}"
            ...
            if (elements != null) {
                ...
                for (element in elements) {
                    ...
                    if((title != "")){
                        ...
                        val noticeData = NoticeData(title,date, link, "sports" + value)
